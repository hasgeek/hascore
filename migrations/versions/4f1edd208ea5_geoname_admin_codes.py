...
def downgrade():
    op.create_table('geo_alt_name',
        ...
        sa.Column('iso_language', sa.VARCHAR(length=7), autoincrement=False, nullable=True),
        sa.Column('alternate_name', sa.VARCHAR(length=200), autoincrement=False, nullable=True),
        sa.Column('is_preferred_name', sa.BOOLEAN(), autoincrement=False, nullable=True),
